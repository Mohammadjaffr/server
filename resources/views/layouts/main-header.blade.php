        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                        ...
                        <div class="menu-header-content bg-primary text-left">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning ml-auto my-auto float-right">
                                    <a href="\MarkAsRead_all">Mark All Read</a></span>
                            </div>
                        ...
                        <div >
                            @foreach (auth()->user()->unreadNotifications as $notification)
                                <div class="main-notification-list Notification-scroll">
                                    <a class="d-flex p-3 border-bottom" href="{{route('item.show',$notification->data['id'])}}">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt="" src="{{asset('assets/img/'.Auth::user()->path)}}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                               <div class="main-img-user"><img alt="" src="{{asset('assets/img/'.Auth::user()->path)}}" class=""></div>
