            ...
            <div class="card">
                <div class="card-header pb-0">
                    @can('add client')
                        ...
                        <div >
                            <a class=" btn btn-primary btn-block"  href="{{route('client.create')}}">ADD CLIENT</a>
                        </div>
                    @endcan
                </div>
                <div class="card-body">
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            @foreach($input as $x)
                                ...
                                <tr >
                                    ...
                                    <td>{{$x->client_country}}</td>
                                    <td>
                                        @can('edit client')
                                        <div class="btn-group">
                                            <a href="{{ route('client.edit', $x->id) }}" class="btn btn-sm btn-primary"><i class="las la-pen"></i></a>
                                        </div>
                                        @endcan
                                            @can('delete client')
                                        <div class="btn-group">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content modal-content-demo">
                                            <div class="modal-header">
                                                <h6 class="modal-title">Delete Client</h6>
                                            </div>
                                            <form action="{{route('client.destroy',$x->id)}}"method="post">
                                                @method('delete')
                                                @csrf
                                                <div class="modal-body">

                                                    <p>Are you sure to delete this client? </p>
                                                    <input type="text"class="form-control"value="{{$x->client_name}}" readonly>
