...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> Reports</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Vendors</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <br><br>
                    <form action="/Search_vendor" method="get" role="search" autocomplete="off">
                        {{ csrf_field() }}

                        <div class="row" id="vendor_report">
                            <div class="col">
                                <label for="inputName" class="control-label">Vendor</label>
                                <select name="vendor" class="form-control select2" onclick="console.log($(this).val())"
