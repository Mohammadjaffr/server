...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Setting</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/User</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form  action="{{route('user.update',$user->id)}}"method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-2">
                            <div class="col mb-0">
                                ...
                                <input id="spec" type="text" name="spec"class="form-control"value="{{$user->spec}}">
