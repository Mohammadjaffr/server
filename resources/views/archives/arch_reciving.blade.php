<div class="table-responsive">
    <table class="table text-md-nowrap" id="example1">
        ...
        @foreach($invoices as $invoice)
            ...
            <tr>
                <td>{{$i}}</td>
                <td>{{$invoice->vend->vendor_name}}</a></td>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu tx-13">
                            ...
                            <a class=" btn btn-primary btn-sm dropdown-item" href="{{route('restore_rec',$invoice->id)}}"><i class=" text-primary fa fa-edit"> restore</i></a>
            ...
            <div class="modal" id="delete{{$invoice->id}}">
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <form action="{{route('delete_rec',$invoice->id)}}"method="get">
                            @csrf
