            ...
            <div class=" main-content-body-invoice" id="print">
                <div class="card card-invoice">
                    <div class="card-body">
                        ...
                        <a class="btn btn-danger rounded-10  float-left mt-3 mr-2" onclick="printDiv()" href="#"id="print_Button">
                            <i class="mdi mdi-printer ml-1"></i> print
                        </a>
                        <a class="btn btn-primary rounded-10  float-left mt-3 mr-2"    href="{{route('receive.index')}}" id="bake">
