            ...
            <div class="card">
                <div class="card-header pb-0">
                    @can('add transport')
                        ...
                        <div >
                            <a class=" btn btn-primary btn-block"  href="{{route('transport.create')}}">ADD TRANSPORT</a>
                        </div>
                    @endcan
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tr>
                                ...
                                <th class="wd-lg-20p"><span>plate_no</span></th>
                            ...
                            @foreach($input as $x)
                                ...
                                <tr >
                                    ...
                                    <td>{{$x->trans_email}}</td>
                                    <td>{{$x->plate_no}}</td>
                                    <td>{{$x->trans_address}}</td>
                                    <td>
                                        @can('edit transport')
                                        <div class="btn-group">
                                            <a href="{{ route('transport.edit', $x->id) }}" class="btn btn-sm btn-primary"><i class="las la-pen"></i></a>
                                        </div>
                                        @endcan
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content modal-content-demo">
                                            <div class="modal-header">
                                                <h6 class="modal-title">Delete transport</h6>
                                            </div>
                                            <form action="{{route('transport.destroy',$x->id)}}"method="post">
                                                @method('delete')
                                                @csrf
                                                <div class="modal-body">

                                                    <p>Are you sure to delete this transport? </p>
                                                    <input type="text"class="form-control"value="{{$x->transport_name}}" readonly>
