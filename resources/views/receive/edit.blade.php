    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('receive.update', $invoice->id) }}" id="invoiceForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="vend_id" id="vendor_name" class="form-control">
                                        ...
                                        @foreach ($vendors as $vendor)
                                            <option value="{{ $vendor->id }}" @if($vendor->id == $invoice->vend_id) selected @endif>{{ $vendor->vendor_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="store_id" id="store_id" class="form-control">
                                        ...
                                        @foreach ($stores as $store)
                                            <option value="{{ $store->id }}" @if($store->id == $invoice->store_id) selected @endif>{{ $store->store_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="note" class="form-control" value="{{ $invoice->note }}">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#invoiceForm').submit(function(event) {
                ...
                $.ajax({
                    url: '{{ route("receive.update", $invoice->id) }}', // Change this to your server endpoint
                    method: 'POST',
                    data: $(this).serialize(),
